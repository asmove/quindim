...
syms F_th F_phi m Lg L b_th b_phi g real;
syms x xp xpp real;
...
params = [m Lg L b_th b_phi g];

% Damper and springs
damper_th = build_damper(b_th, [0; 0; 0], [0; 0; thp]);
damper_phi = build_damper(b_phi, [0; 0; 0], [0; 0; thp]);
...
sys.descrip.syms = [m I_1 I_2 I_3 Lg L b_th b_phi g];
