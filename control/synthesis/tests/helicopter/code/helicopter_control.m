...
% States
saveas(hfigs_states, ['~/Dropbox/Public/control/helicopter/x_', ...
                      int2str(100*perc), posfix, '.eps'], 'eps');

% States
saveas(hfigs_u, ['~/Dropbox/Public/control/helicopter/u_', ...
                 int2str(100*perc), posfix, '.eps'], 'eps');

% Sliding function
saveas(hfigs_s, ['~/Dropbox/Public/control/helicopter/s', ...
                 int2str(100*perc), posfix, '.eps'], 'eps');
